...
public class AnnuncioHomeDTO {
    ...
    public AnnuncioHomeDTO() {}

    public AnnuncioHomeDTO(Long idAnnuncio, LocalDateTime dataPubblicazione, boolean visibile, int visualizzazioni,
                           Long idImmobile, String titoloImmobile, String indirizzo, BigDecimal prezzo) {
