...
public class ImmobilePersonaleDTO {
    ...
    public ImmobilePersonaleDTO(Long idImmobile, String titolo, String descrizione, BigDecimal prezzo, Tipologia tipologia,
            StatoImmobile stato, Integer superficie, String indirizzo, boolean hasAnnuncio) {
    ...
    public boolean isHasAnnuncio() {
        return hasAnnuncio;
    }

    public void setHasAnnuncio(boolean hasAnnuncio) {
        this.hasAnnuncio = hasAnnuncio;
    }
}
